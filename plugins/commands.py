...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, HOW_TO_POST_SHORT, DIRECT_GEN_DB, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SUPPORT_CHAT, MAX_B_TN, VERIFY, HOWTOVERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, IS_TUTORIAL, PREMIUM_USER, PICS, SUBSCRIPTION
from utils import get_settings, get_size, is_req_subscribed, save_group_settings, temp, verify_user, check_token, check_verification, get_token, get_shortlink, get_tutorial, gen_link, clean_title, get_poster, temp, short_link
...
async def start(client, message):
    ...
    if len(message.command) != 2:
        ...
        if curr_time < 12:
            ...
            gtxt = "Gᴏᴏᴅ Nɪɢʜᴛ 👋"
        m=await message.reply_text("<i>Wᴇʟᴄᴏᴍᴇ Tᴏ <b>Tʜᴇ Movie SearchXBot</b>.\nʜᴏᴘᴇ ʏᴏᴜ'ʀᴇ ᴅᴏɪɴɢ ᴡᴇʟʟ...</i>")
        ...
        await asyncio.sleep(0.4)
        await m.delete()        
        m=await message.reply_sticker("CAACAgUAAxkBAAIrcWaD002yqo4zjkVKrzISozVkuSzGAAKhDQACG0uYVtd5ek9MnWxHHgQ") 
    ...
    if len(message.command) == 2 and message.command[1] in ["premium"]:
        buttons = [[
                    InlineKeyboardButton('📲 Sᴇɴᴅ Pᴀʏᴍᴇɴᴛ Sᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(1397269319))
                  ],[
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 Jᴏɪɴ Uᴘᴅᴀᴛᴇꜱ Cʜᴀɴɴᴇʟ 📌', url=f'https://t.me/+uL0218mcwjNmNjNl') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url=f'https://t.me/+uL0218mcwjNmNjNl') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
    ...
    if data.startswith("sendfiles"):
        ...
        for file in files:
            ...
            [
             [
              InlineKeyboardButton('🚀 Fᴀꜱᴛ ᴅᴏᴡɴʟᴏᴀᴅ / Wᴀᴛᴄʜ Oɴʟɪɴᴇ 🧿', callback_data=f'generate_stream_link:{file_id}'),
             ],
             [
              InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url=f'https://t.me/+uL0218mcwjNmNjNl') #Don't change anything without contacting me @LazyDeveloperr
             ]
            ...
            k = await client.send_message(chat_id=message.from_user.id,text=f"🫂 ʜᴇʏ {message.from_user.mention}, {gtxt}\n\n✅ ʏᴏᴜʀ ʟɪɴᴋ ɪꜱ ʀᴇᴀᴅʏ, ᴋɪɴᴅʟʏ ᴄʟɪᴄᴋ ᴏɴ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ.\n\n⚠️ ꜰɪʟᴇ ɴᴀᴍᴇ : <code>{files.file_name}</code> \n\n📥 ꜰɪʟᴇ ꜱɪᴢᴇ : <code>{get_size(files.file_size)}</code>\n\n", reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton('🔻 Bᴜʏ Sᴜʙꜱᴄʀɪᴘᴛɪᴏɴ : Rᴇᴍᴏᴠᴇ ᴀᴅꜱ 🔻', callback_data="seeplans")                            
                        ]
                    ]
                )
            )
    ...
    files = files_[0]
    title = '@PK_LinkZz ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Aᴅᴍɪɴ')
...
async def shortlink(bot, message):
    ...
    try:
        ...
        return await message.reply_text("<b>ᴄᴏᴍᴍᴀɴᴅ ɪɴᴄᴏᴍᴘʟᴇᴛᴇ !\nɢɪᴠᴇ ᴍᴇ ᴄᴏᴍᴍᴀɴᴅ ᴀʟᴏɴɢ ᴡɪᴛʜ ꜱʜᴏʀᴛɴᴇʀ ᴡᴇʙꜱɪᴛᴇ ᴀɴᴅ ᴀᴘɪ.\n\nꜰᴏʀᴍᴀᴛ : <code>/shortlink modijiurl.com 6a0a4f826e12f701a433063ebbe730caa1c29c38</code>")
    reply = await message.reply_text("<b>Pʟᴇᴀꜱᴇ ᴡᴀɪᴛ...</b>")
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/Howtodowloa/9</code></b>")
    ...
    try:
        ...
        if chat_id in user_states:
            ...
            if current_state == "awaiting_num_files":
                ...
                summary_message = f"**☆{title}**\n\n**Genre 🎥 - {imdb_data.get('genres')}**\n\n**𖤍 Uᴘʟᴏᴀᴅᴇᴅ Bʏ 𓆩♱𓆪 @PK_LinkZz**\n\n**𓆩🔻𓆪 Dɪʀᴇᴄᴛ Tᴇʟᴇɢʀᴀᴍ Fɪʟᴇs 𓆩🔻𓆪**\n\n**{file_info_text}**\n\n**\n\n**✅ Note : [Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ]({HOW_TO_POST_SHORT})**\n\n**𓆩🔻𓆪 Sᴛʀᴇᴀᴍ/Fᴀsᴛ Dᴏᴡɴʟᴏᴀᴅ 𓆩🔻𓆪**\n\n**{stream_links_text}**\n\n**✅ Note : [Hᴏᴡ Tᴏ Dᴏᴡɴʟᴏᴀᴅ]({HOW_TO_POST_SHORT})**\n\n**♥ー𖤍 𓆩s♥ʜᴀʀᴇ ᴡɪᴛʜ ғʀɪᴇɴᴅs♥𓆪 𖤍ー**"
